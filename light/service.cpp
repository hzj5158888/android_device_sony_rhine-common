...
#define LOG_TAG "android.hardware.light@2.0-service.rhine"
...
const static std::string kLcdBacklightPath = "/sys/class/leds/wled:backlight/brightness"; //rhine only
const static std::string kLcdMaxBacklightPath = "/sys/class/leds/wled:backlight/max_brightness";  //rhine only
